  ...
  return (
    <div className={`space-y-4 flex flex-col h-full ${isCompact ? '' : 'p-6'}`}>
      ...
      <div className={`flex-1 flex flex-col ${isCompact ? 'bg-black min-h-0' : 'bg-slate-950 p-6 rounded-xl border border-slate-700 min-h-[500px]'}`}>
        ...
        <div
          className={`text-sm text-green-400 font-mono whitespace-pre-wrap flex-1 overflow-auto focus-visible:outline focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset ${isCompact ? 'p-2' : 'bg-black p-4 rounded-lg'}`}
          tabIndex={0}
          role="log"
          aria-live="polite"
        >
