...
export default function Quantizer() {
  ...
  const startProcessAndViewLogs = (cmd, setStartingState) => {
    ...
    setTimeout(() => {
      window.dispatchEvent(new CustomEvent("runCommandTriggered", { detail: cmd }));
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 space-y-4">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md bg-purple-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-purple-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600 transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
        >
