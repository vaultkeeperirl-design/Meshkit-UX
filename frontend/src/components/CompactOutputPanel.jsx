        ...
        <div className="flex justify-between items-center border-b border-slate-800 mb-4">
            <div className="flex">
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium uppercase tracking-wider transition-colors focus-visible:outline focus-visible:ring-2 focus-visible:ring-blue-500 rounded-tl-lg ${
                ...
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium uppercase tracking-wider transition-colors focus-visible:outline focus-visible:ring-2 focus-visible:ring-blue-500 rounded-tr-lg ${
