        ...
        <div className="flex justify-between items-center border-b border-slate-800 mb-4">
            <div className="flex" role="tablist" aria-label="Output Views">
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium uppercase tracking-wider transition-all duration-200 active:scale-95 focus-visible:outline focus-visible:ring-2 focus-visible:ring-blue-500 rounded-t-md ${
                        activeTab === "yaml" ? "text-blue-400 border-b-2 border-blue-500" : "text-slate-400 border-b-2 border-transparent hover:text-slate-300 hover:bg-slate-800/50"
                    }`}
                >
                    YAML Output
                </button>
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium uppercase tracking-wider transition-all duration-200 active:scale-95 focus-visible:outline focus-visible:ring-2 focus-visible:ring-blue-500 rounded-t-md ${
                        activeTab === "logs" ? "text-blue-400 border-b-2 border-blue-500" : "text-slate-400 border-b-2 border-transparent hover:text-slate-300 hover:bg-slate-800/50"
                    }`}
                >
                    Process & Logs
                </button>
            ...
            {activeTab === "yaml" && (
                <button
                    ...
                    className="text-slate-400 hover:text-white hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 active:scale-95 focus-visible:outline focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-1.5 mr-2"
